...
const (
	...
	GateWayError           = "TikTok Gateway 暂时不能处理您的请求，请稍后重试！"
	GateWayParamsErrorCode = 40002
	GateWayParamsError     = "TikTok Gateway 无法响应您的请求，请重启 APP 或稍后再试!"
)
...
const (
	...
	UnableToAddMessageErrorCode      = 50016
	UnableToAddMessageRrror          = "发送消息出错"
	UnableToQueryMessageErrorCode    = 50017
