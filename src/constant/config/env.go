...
type envConfig struct {
	...
	MySQLHost             string  `env:"POSTGRESQL_HOST"`
	MySQLPort             string  `env:"POSTGRESQL_PORT"`
	MySQLUser             string  `env:"POSTGRESQL_USER"`
	MySQLPassword         string  `env:"POSTGRESQL_PASSWORD"`
	MySQLDataBase         string  `env:"POSTGRESQL_DATABASE"`
	...
	MySQLSchema           string  `env:"POSTGRESQL_SCHEMA" envDefault:""`
	...
	MySQLPrefix           string  `env:"POSTGRESQL_PREFIX" envDefault:""`
	MySQLReplicaState     string  `env:"POSTGRESQL_REPLICA"`
	MySQLReplicaAddress   string  `env:"POSTGRESQL_REPLICA_ADDR"`
	MySQLReplicaUsername  string  `env:"POSTGRESQL_REPLICA_USER"`
	MySQLReplicaPassword  string  `env:"POSTGRESQL_REPLICA_PASSWORD"`
